      ...
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        ...
        <div className="max-w-2xl mx-auto mt-16 rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            ...
            >
              {includedFeatures.map((feature) => (
                <li key={feature} className="flex gap-x-3">
                  <BsCheck2
                    className="flex-none w-5 h-6 fill-indigo-600"
                    aria-hidden={true}
                  />
                  {feature}
                </li>
          ...
          <div className="p-2 -mt-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="py-10 text-center rounded-xl bg-gray-50 ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
